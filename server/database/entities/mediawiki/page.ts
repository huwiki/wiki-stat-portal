...
export class Page {
	...
	@Column({ name: "page_touched", type: "varbinary", length: 14, scale: 0, transformer: bufferToStringTransformer })
	public lastTouchTimestamp: Date;

	// page_links_updated varbinary(14)
	@Column({ name: "page_links_updated", type: "varbinary", length: 14, scale: 0, transformer: bufferToStringTransformer })
