...
CREATE TABLE `huwikisource_actor_daily_stats_v2` (
	...
	INDEX `huwikisource_actor_daily_stats_v2_date` (`date`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE `huwikisource_actor_daily_stats_by_ns_v2` (
	...
	INDEX `huwikisource_actor_daily_stats_by_ns_v2_date` (`actor_id`, `date`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;


-- Statistics by change tag
CREATE TABLE `huwikisource_edit_stats_by_tag_v2` (
...
CREATE TABLE `huwikisource_actor_edit_stats_by_tag_v2` (
	`actor_id` bigint(20) NOT NULL,
	`change_tag_id` int(10) NOT NULL,
	`date` date NOT NULL,
	`daily_edits` int(11) NOT NULL,
...
CREATE TABLE `huwikisource_edit_stats_by_ns_tag_v2` (
	`namespace` int(11) NOT NULL,
	`change_tag_id` int(10) NOT NULL,
	`date` date NOT NULL,
	`daily_edits` int(11) NOT NULL,
...
CREATE TABLE `huwikisource_actor_edit_stats_by_ns_tag_v2` (
	`actor_id` bigint(20) NOT NULL,
	`namespace` int(11) NOT NULL,
	`change_tag_id` int(10) NOT NULL,
	`date` date NOT NULL,
	...
	CONSTRAINT `huwikisource_actor_edit_stats_by_ns_tag_v2_actor` FOREIGN KEY (`actor_id`) REFERENCES `huwikisource_actor_v2` (`actor_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;


-- Statistics by log type
CREATE TABLE `huwikisource_log_stats_by_type_v2` (
...
CREATE TABLE `huwikisource_actor_log_stats_by_type_v2` (
	`actor_id` bigint(20) NOT NULL,
	...
	CONSTRAINT `huwikisource_actor_log_stats_by_type_v2_actor` FOREIGN KEY (`actor_id`) REFERENCES `huwikisource_actor_v2` (`actor_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;


-- Statistics by log action
CREATE TABLE `huwikisource_log_stats_by_action_v2` (
	`log_action` varchar(32) CHARACTER SET utf8 NOT NULL,
	`date` date NOT NULL,
	`daily_log_events` int(11) NOT NULL,
	`log_events_to_date` int(11) NOT NULL,
...
CREATE TABLE `huwikisource_actor_log_stats_by_action_v2` (
	`actor_id` bigint(20) NOT NULL,
	`log_action` varchar(32) CHARACTER SET utf8 NOT NULL,
	`date` date NOT NULL,
	`daily_log_events` int(11) NOT NULL,
	...
	CONSTRAINT `huwikisource_actor_log_stats_by_action_v2_actor` FOREIGN KEY (`actor_id`) REFERENCES `huwikisource_actor_v2` (`actor_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;


-- Statistics by log type and action
CREATE TABLE `huwikisource_log_stats_by_type_action_v2` (
	`log_type` varchar(32) CHARACTER SET utf8 NOT NULL,
	`log_action` varchar(32) CHARACTER SET utf8 NOT NULL,
	`date` date NOT NULL,
	`daily_log_events` int(11) NOT NULL,
...
CREATE TABLE `huwikisource_actor_log_stats_by_type_action_v2` (
	`actor_id` bigint(20) NOT NULL,
	`log_type` varchar(32) CHARACTER SET utf8 NOT NULL,
	`log_action` varchar(32) CHARACTER SET utf8 NOT NULL,
	`date` date NOT NULL,
	...
	CONSTRAINT `huwikisource_actor_log_stats_by_type_action_v2_actor` FOREIGN KEY (`actor_id`) REFERENCES `huwikisource_actor_v2` (`actor_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
