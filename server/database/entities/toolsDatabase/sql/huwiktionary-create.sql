...
-- Statistics by date
CREATE TABLE `huwiktionary_daily_stats` (
	`date` date NOT NULL,
...
CREATE TABLE `huwiktionary_actor_daily_stats` (
	`actor_id` bigint(20) NOT NULL,
	`date` date NOT NULL,
	`daily_edits` int(11) NOT NULL,
	`edits_to_date` int(11) NOT NULL,
	...
	CONSTRAINT `huwiktionary_actor_daily_stats_actor` FOREIGN KEY (`actor_id`) REFERENCES `huwiktionary_actor` (`actor_id`) ON DELETE CASCADE ON UPDATE CASCADE,
	INDEX `huwiktionary_actor_daily_stats_date` (`date`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;


-- Statistics by namespace
CREATE TABLE `huwiktionary_daily_stats_by_ns` (
...
CREATE TABLE `huwiktionary_actor_daily_stats_by_ns` (
	`actor_id` bigint(20) NOT NULL,
	`namespace` int(11) NOT NULL,
	`date` date NOT NULL,
	`daily_edits` int(11) NOT NULL,
	...
	CONSTRAINT `huwiktionary_actor_daily_stats_by_ns_actor` FOREIGN KEY (`actor_id`) REFERENCES `huwiktionary_actor` (`actor_id`) ON DELETE CASCADE ON UPDATE CASCADE,
	INDEX `huwiktionary_actor_daily_stats_by_ns_date` (`actor_id`, `date`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;


-- Statistics by change tag
CREATE TABLE `huwiktionary_edit_stats_by_tag` (
...
CREATE TABLE `huwiktionary_actor_edit_stats_by_tag` (
	`actor_id` bigint(20) NOT NULL,
	`change_tag_id` int(10) NOT NULL,
	`date` date NOT NULL,
	`daily_edits` int(11) NOT NULL,
	...
	CONSTRAINT `huwiktionary_actor_edit_stats_by_nsct_actor` FOREIGN KEY (`actor_id`) REFERENCES `huwiktionary_actor` (`actor_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;


-- Statistics by namespace and change tag
CREATE TABLE `huwiktionary_edit_stats_by_ns_tag` (
	`namespace` int(11) NOT NULL,
	`change_tag_id` int(10) NOT NULL,
	`date` date NOT NULL,
	`daily_edits` int(11) NOT NULL,
...
CREATE TABLE `huwiktionary_actor_edit_stats_by_ns_tag` (
	`actor_id` bigint(20) NOT NULL,
	`namespace` int(11) NOT NULL,
	`change_tag_id` int(10) NOT NULL,
	`date` date NOT NULL,
	...
	CONSTRAINT `huwiktionary_actor_edit_stats_by_ns_tag_actor` FOREIGN KEY (`actor_id`) REFERENCES `huwiktionary_actor` (`actor_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE `huwiktionary_actor_log_stats_by_type` (
	...
	CONSTRAINT `huwiktionary_actor_log_stats_by_type_actor` FOREIGN KEY (`actor_id`) REFERENCES `huwiktionary_actor` (`actor_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE `huwiktionary_actor_log_stats_by_action` (
	...
	CONSTRAINT `huwiktionary_actor_log_stats_by_action_actor` FOREIGN KEY (`actor_id`) REFERENCES `huwiktionary_actor` (`actor_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE `huwiktionary_actor_log_stats_by_type_action` (
	...
	CONSTRAINT `huwiktionary_actor_log_stats_by_type_action_actor` FOREIGN KEY (`actor_id`) REFERENCES `huwiktionary_actor` (`actor_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
